...
import '../../layouts/chat/socialoo_chat_main.dart';
import '../../layouts/menu/all_stories.dart';
import '../../layouts/menu/all_videos.dart';
import '../../layouts/menu/comming_soon_page.dart';
import '../../layouts/menu/discover.dart';
import '../../layouts/menu/help_support.dart';
import '../../layouts/menu/recent_users.dart';
import '../../layouts/user/editprofile1.dart';
import '../../layouts/user/login.dart';
import '../../layouts/user/myFollowers.dart';
import '../../layouts/user/myFollowing.dart';
import '../../layouts/user/profile.dart';
import '../../layouts/user/saved_bookmarks.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedTheme(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          flexibleSpace:
              Container(decoration: BoxDecoration(color: ColorResources.blue1)),
          elevation: 0.5,
          title: Text(
            "Menu",
