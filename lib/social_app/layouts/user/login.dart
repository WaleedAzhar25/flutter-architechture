...
import '../../layouts/user/forgotpass.dart';
import '../../layouts/user/google_sign_in.dart';
import '../../layouts/user/signup.dart';
import '../../layouts/widgets/bezier_container.dart';
    ...
    try {
      ...
      FirebaseMessaging.instance.getToken().then((token) async {
        ...
        if (response.statusCode == 200) {
          ...
          // print(response.body);
          d.log('json login response is : ${response.body}');
