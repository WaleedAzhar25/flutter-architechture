        ...
        children: [
          ...
          Marquee(
            child: Row(
              children: [
                Text("[ "),
                PriceWidget(price: rangeValues.start.toInt(), size: 16, isBoldText: false, color: textPrimaryColorGlobal, decimalPoint: 0),
                Text(" - "),
                PriceWidget(price: rangeValues.end.toInt(), size: 16, isBoldText: false, color: textPrimaryColorGlobal, decimalPoint: 0),
                Text("]"),
              ],
            ),
          ).center(),
