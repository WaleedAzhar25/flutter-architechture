import 'package:sixam_mart/service/component/base_scaffold_widget.dart';
...
import 'package:sixam_mart/service/screens/jobRequest/book_post_job_request_screen.dart';
import 'package:sixam_mart/service/screens/jobRequest/components/bidder_item_component.dart';
  ...
  Widget titleWidget(
    ...
    return Column(
      ...
      children: [
        ...
        8.height,
        if (isReadMore)
          ReadMoreText(detail, style: detailTextStyle)
        else
                ...
                children: [
                  SingleChildScrollView(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        postJobDetailWidget(data: snap.data.postRequestDetail)
                            .paddingAll(16),
                        if (snap.data.postRequestDetail.service
                            .validate()
                            .isNotEmpty)
                        ...
                        if (snap.data.biderData.validate().isNotEmpty)
                          bidderWidget(snap.data.biderData.validate(),
                              postJobDetailResponse: snap.data),
                      ],
                    ),
                  ).makeRefreshable,
                  if (snap.data.postRequestDetail.status.validate() ==
                      ...
                      child: AppButton(
                        ...
                        onTap: () async {
                          BookPostJobRequestScreen(
                            postJobDetailResponse: snap.data,
                            providerId: snap.data.postRequestDetail.providerId
                                .validate(),
                            jobPrice:
                                snap.data.postRequestDetail.jobPrice.validate(),
                          ).launch(context);
                        },
                      ),
                    ),
