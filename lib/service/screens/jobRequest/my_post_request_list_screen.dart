...
import 'package:sixam_mart/service/screens/jobRequest/components/my_post_request_item_component.dart';
import 'package:sixam_mart/service/screens/jobRequest/create_post_request_screen.dart';
...
class _MyPostRequestListScreenState extends State<MyPostRequestListScreen> {
  Future<List<PostJobData>> future;
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      child: Scaffold(
        appBar: appBarWidget(language.myPostJobList,
            textColor: white,
            elevation: 0.0,
        ...
        bottomNavigationBar: AppButton(
          child:
              Text(language.requestNewJob, style: boldTextStyle(color: white)),
          color: context.primaryColor,
          width: context.width(),
          onTap: () async {
