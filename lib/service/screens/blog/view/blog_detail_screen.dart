...
import 'package:sixam_mart/service/screens/blog/blog_repository.dart';
import 'package:sixam_mart/service/screens/blog/component/blog_detail_header_component.dart';
                    ...
                    if (snap.data.blogDetail.createdAt.validate().isNotEmpty)
                      Row(
                        children: [
                          ...
                          Text(snap.data.blogDetail.createdAt.validate(),
                    ...
                    if (snap.data.blogDetail.totalViews != 0)
                      Row(
                        children: [
                          ...
                          8.width,
                          Text('${snap.data.blogDetail.totalViews.validate()} ',
                              style: boldTextStyle()),
                          Text(language.views,
                              style: boldTextStyle(),
                              maxLines: 1,
      ...
      builder: (context, snap) {
        return Scaffold(
          ...
          floatingActionButton: (snap.hasData &&
                  snap.data.blogDetail.isFeatured.validate(value: 0) == 1)
              ? FloatingActionButton(
                  elevation: 0.0,
                  child: Image.asset(ic_featured,
