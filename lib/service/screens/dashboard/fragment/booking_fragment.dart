...
import 'package:sixam_mart/service/screens/booking/booking_detail_screen.dart';
import 'package:sixam_mart/service/screens/booking/component/booking_item_component.dart';
import 'package:sixam_mart/service/screens/booking/component/status_dropdown_component.dart';
    ...
    return WillPopScope(
      onWillPop: () async {
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
                builder: (context) => DashboardScreen(pageIndex: 2)),
            (route) => true);
        return true;
      },
      child: Scaffold(
