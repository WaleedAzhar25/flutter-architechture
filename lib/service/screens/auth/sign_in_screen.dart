...
import 'package:sixam_mart/service/component/base_scaffold_body.dart';
import 'package:sixam_mart/service/main.dart';
import 'package:sixam_mart/service/network/rest_apis.dart';
import 'package:sixam_mart/service/screens/auth/forgot_password_screen.dart';
import 'package:sixam_mart/service/screens/auth/otp_login_screen.dart';
import 'package:sixam_mart/service/screens/auth/sign_up_screen.dart';
  ...
  void loginUsers({bool isDirectLogin = false}) async {
    void login() async {
      ...
      await loginUser(request).then((loginResponse) async {
        d.log(
            'login respoonse is : ${loginResponse.userData.toJson()}  ${loginResponse.message}');
        if (isRemember) {
        ...
        if (loginResponse.userData != null) {
          ...
          d.log('before singin with email and password');
          await authService
            ...
            userService
                ...
                .catchError((e) {
              // toast(e.toString());
              d.log('updatePlayerIdInFirebase : ${e.toString()}');
            });
        ...
        toast(e.toString());
        d.log('login user : ${e.toString()}');
      });

      appStore.setLoading(false);
      d.log('after loading finished');
    }
