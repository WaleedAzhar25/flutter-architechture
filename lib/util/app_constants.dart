...
class AppConstants {
  static const String APP_NAME = 'easy city';
  static const double APP_VERSION = 1.6;

  static const String BASE_URL = 'https://manager.easycity.app';
  // static const String BASE_URL = 'https://easy-city.iscompany-eg.website';
