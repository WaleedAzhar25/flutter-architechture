...
import 'package:sixam_mart/view/customization/videos/video_widget.dart';
...
import 'package:sixam_mart/view/customization/blogs/blog_widget.dart';
                        ...
                        ? Positioned(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    width: 1, color: ColorResources.white12),
                              ),
                            ))
                        : SizedBox(),
                  ]);
            ...
            child: !showMobileModule
                ? Column(
                    ...
                    children: [
                        ...
                        BlogWidget(splashController.module != null
                            ? splashController.module.id.toString() ?? '1'
                            : '1'),
                        VideoWidget(splashController.module != null
                            ? splashController.module.id.toString() ?? '1'
                            : '1'),
